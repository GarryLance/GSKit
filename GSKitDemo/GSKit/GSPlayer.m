...
@property(assign,nonatomic) id <GSPlayerDelegate> delegate;
...
- (instancetype)initWithFrame:(CGRect)frame player:(GSPlayer *)player
{
    ...
    if (self)
    {
        ...
        self.topBarView = [[[GSVideoPlayerTopBarView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height*0.2)] autorelease];
        self.controlBarView = [[[GSVideoPlayerControlBarView alloc] initWithFrame:CGRectMake(0, frame.size.height-frame.size.height*0.276, frame.size.width, frame.size.height*0.276)] autorelease];
        self.processView = [[[GSVideoPlayerProcessView alloc] initWithFrame:CGRectMake(0, frame.size.height/2-12.5, 50, 25)] autorelease];
...
@property(assign,nonatomic) GSVideoPlayerFullScreenWindow * fullScreenWindow;
...
- (void)videoPlayerView:(GSVideoPlayerView *)playerView fullScreen:(id)sender
{
    if (!self.isFullScreen)
    {
        ...
        _fullScreenWindow = [[GSVideoPlayerFullScreenWindow alloc] initWithFrame:[UIScreen mainScreen].bounds];
