...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.gs_imageView = [[UIImageView alloc] init];
        self.gs_titleLabel = [[UILabel alloc] init];
...
- (void)setGs_model:(GSCollectionViewItemModel *)gs_model
{
    ...
    {
        _gs_titleLabel.attributedText = [[NSAttributedString alloc] initWithString:gs_model.title attributes:gs_model.titleAttributes];
    }
    else
    {
