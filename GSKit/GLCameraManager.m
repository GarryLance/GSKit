...
@interface GLCameraManager () <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property(assign,nonatomic) GLCameraTakePhotoBlock takePhotoCompletionBlock;
...
@implementation GLCameraManager
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        _layerPreview = [[GLCameraLayer alloc] init];
