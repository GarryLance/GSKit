...
/**播放视图*/
@property(assign,nonatomic) GSVideoPlayerView * playerView;
/**尺寸*/
...
/**代理*/
@property(assign,nonatomic) id <GSVideoPlayerViewDelegate> delegate;
/**视频幕布上的播放/暂停按钮*/
@property(retain,nonatomic) UIButton * playBtnOnScreen;
@property(assign,nonatomic) CGRect playBtnOnScreenRect;
/**顶部栏*/
@property(retain,nonatomic) GSVideoPlayerTopBarView * topBarView;
/**底部控制栏*/
@property(retain,nonatomic) GSVideoPlayerControlBarView * controlBarView;
/**播放前缓冲的进度栏，需要自定义的时候可以整个替换掉*/
@property(retain,nonatomic) GSVideoPlayerProcessView * processView;
...
@property(assign,nonatomic) id <GSVideoPlayerDelegate> delegate;
@property(retain,nonatomic) GSPlayer * player;
@property(retain,nonatomic) GSVideoPlayerView * playerView;
